  ...
  >
    <div class="w-[500px] h-fit bg-white rounded-2xl flex p-6 flex-col gap-3" @click.stop="">
      ...
      <div class="flex flex-col">
        <p>Tên</p>
        <input v-model="userData.name" type="text" class="rounded-md" style="outline: none" />
      </div>
      <div class="flex flex-col">
        <p>Email</p>
        <input v-model="userData.email" type="text" class="rounded-md" style="outline: none" />
      </div>
      <div class="flex flex-col">
        <p>Role</p>
        <select class="rounded-md" v-model="userData.role" name="" id="">
